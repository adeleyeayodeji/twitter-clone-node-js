...
class TweetsAndReplies extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
  render() {
    const elements = [1, 2, 3, 2, 2, 2, 2, 2, 2];
    return (
              ...
              <div className="card w-100">
                ...
                >
                  <div className="row no-gutters">
                    ...
                    <div
                      className={
                        this.props.windowsWidth < 600 ? "col-10 pr-3" : "col-11"
                      }
                    >
...
export default connect(mapStateToProps, mapDispatchToProps())(TweetsAndReplies);
